        ...
        <div>
            <div className="card bg-dark text-white banner">
                ...
                <div className="card-img-overlay text-center mt-5">
                    ...
                    <h1 className="card-title ms-5">Find <span className="text-warning">Yours!</span> 
                    </h1>
                    <p className="card-text">This is a wider card with supporting text below as a natural <br />
                     <span className="ms-5">lead-in to additional content. This content is a little bit longer.</span></p>
